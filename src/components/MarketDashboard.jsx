...
const MarketDashboard = () => (
  <Section className="w-full bg-black py-20 px-4 sm:px-6 lg:px-8">
    {/* Header */}
    <div className="max-w-6xl mx-auto mb-8 flex flex-col sm:flex-row justify-between items-center gap-3">
      <h2 className="text-2xl md:text-3xl font-bold text-white">
        Market <span className="text-green-400">Data Dashboard</span>
      </h2>
      <span className="bg-green-400/10 text-green-400 font-medium px-3 py-1 rounded text-sm">Live</span>
    </div>

    {/* Grid */}
    <div className="max-w-6xl mx-auto grid gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
      {/* Indices */}
      <div className="bg-[#181c1a] rounded-xl border border-gray-800 p-5">
      ...
      {/* Chart */}
      <div className="bg-[#181c1a] rounded-xl border border-gray-800 p-5 flex flex-col">
      ...
      <div className="bg-[#181c1a] rounded-xl border border-gray-800 p-5">
        ...
        <ul className="space-y-4">
          {currencyRates.map((curr) => (
            <li key={curr.pair} className="flex justify-between items-center">
      ...
      <div className="bg-[#181c1a] rounded-xl border border-gray-800 p-5">
        ...
        <ul className="space-y-4">
          {commodities.map((com) => (
            <li key={com.name} className="flex justify-between items-center">
    ...
    <div className="max-w-6xl mx-auto text-center mt-10">
      <a href="https://www.google.com/finance/" className="inline-block text-green-400 font-semibold hover:underline text-base sm:text-lg">
